...
CACHE_PREFIX = 'COVID'
TOTAL_REGIONS = ['Global', 'Total', 'Total - Italy']
...
def botons(plot_type="daily_cases", regio="Total", scope="spain", language="en", method=None, acum_regions_key=None):
    _ = translations[language].gettext
    ibt = []
    l_botns = []
    botonets = []
    ...
    for chart in list(string.ascii_lowercase):
        result = [i for i in regions if normal(_(i)[0]).lower() == chart and i != "Global" and i not in acum_regions]
...
def b_alphabet(scope, plot_type="daily_cases", regio="Total", method=None, acum_regions_key=None, language="en"):
    _ = translations[language].gettext
    ibt = []
    botonets = []
    ordre = 0
    ...
    for chart in list(string.ascii_lowercase):
        result = [i for i in regions if normal(_(i)[0]).lower() == chart and i != "Global"]
        len_all += len(result)
