...
REGIONS = {
    ...
    'total-argentina': _('total-argentina'),
    'total-australia': _('total-australia'),
    'total-brazil': _('total-brazil'),
    'total-canada': _('total-canada'),
    'total-chile': _('total-chile'),
    'total-china': _('total-china'),
    'total-colombia': _('total-colombia'),
    'total-germany': _('total-germany'),
    'total-india': _('total-india'),
    'total-mexico': _('total-mexico'),
    'total-portugal': _('total-portugal'),
    'total-us': _('total-us'),
    'total-balears': _('total-balears'),
    'total-mallorca': _('total-mallorca'),
